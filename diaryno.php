...
$sql = "SELECT cno,diaryno,ctype,cyear,pname,rname,radvocates,padvocates,judges,nh,description FROM cs WHERE diaryno='$code'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> " . $row["cno"]."</td><td>".$row["diaryno"]."</td><td>".$row["ctype"]."</td><td>".$row["cyear"]."</td><td>".$row["pname"]."</td><td>".$row["rname"]."</td><td>".$row["radvocates"]."</td><td>".$row["padvocates"]."</td><td>".$row["judges"]."</td><td>".$row["nh"]."</td><td>".$row["jd"]."</td><td>".$row["description"]."</td></tr>";
    }
} else {
    echo "0 results";
}
