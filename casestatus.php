...
.show {display: block;}
	...
	<title>Case Status|Supreme Court Of India</title>
...
window.onclick = function(event) {
  ...
  <div class="container">
    ...
    <a rel="Click Here"style="text-decoration:none;color:red;" href="casestatus.php"><h5>&#9679;Case Status</h5></a>
...
<div class="centerbar">
  	...
  	<form action="cno.php" method="POST">
  <input id="search"  type="text" name="cn" placeholder="Search by Case No." >
</form>
 <form action="diaryno.php" method="POST">
  <input id="search" type="text" name="dn" placeholder="Search by Diary No.">
</form>
<form action="cd.php" method="POST">
  <input id="search" type="text" name="cd" placeholder="Search by Case Date">
</form>
<h2>Case Status</h2>
  <hr>
<table >
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> " . $row["cno"]."</td><td>".$row["diaryno"]."</td><td>".$row["ctype"]."</td><td>".$row["cyear"]."</td><td>".$row["pname"]."</td><td>".$row["rname"]."</td><td>".$row["radvocates"]."</td><td>".$row["padvocates"]."</td><td>".$row["judges"]."</td><td>".$row["nh"]."</td><td>".$row["description"]."</td></tr>";
    }
} else {
    echo "0 results";
}
