...
<ul>
  ...
  <li><a  href="nc.html">Notices &amp; Circulars</a></li>
    <li><a class="active" href="do.html">Daily Orders</a></li>
...
<form action="doDate.php" method="POST">
  <input id="search" type="text" name="date" placeholder="Search by Date (YYYY-MM-DD)">
</form>
<h2>Daily Orders </h2>
  <hr>
<table >
