...
.show {display: block;}
  ...
  <title>Caveats|Supreme Court Of India</title>
...
window.onclick = function(event) {
  ...
  <div class="container">
    ...
    </a><a rel="Click Here" style="text-decoration:none;color:red;" href="cavet.php"> <h5>&#9679;Caveat</h5></a>
...
<div class="desc">
    <form  action="cavetbyid.php" method="POST">
  <input id="search" size="30" type="text" name="id" placeholder="Search by AoR Code" >
</form>
<h2>Caveats</h2>
    <hr>
<table >
...
$sql = "SELECT cavno,slci,diaryno,cause,padvo,radvo,cfees FROM caveat where cavno='$cno'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> " . $row["cavno"]."</td><td>".$row["slci"]."</td><td>".$row["diaryno"]."</td><td>".$row["cause"]."</td><td>".$row["padvo"]."</td><td>".$row["radvo"]."</td><td>".$row["cfees"]."</td></tr>";
    }
} else {
    echo "0 results";
}
