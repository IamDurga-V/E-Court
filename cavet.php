...
window.onclick = function(event) {
  ...
  <div class="container">
    ...
    <a rel="Click Here"style="text-decoration:none;color:red;" href="cavet.php"><h5>&#9679;Caveat</h5></a>
...
<div class="desc">
  ...
  <input id="search" size="30" type="text" name="id" placeholder="Search by Caveats No." >
</form>
<h2>Caveats</h2>
    <hr>
<table >
...
$sql = "SELECT cavno,slci,diaryno,cause,padvo,radvo,cfees FROM caveat";
