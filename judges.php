...
.show {display: block;}
	...
	<title>Judges|Supreme Court Of India</title>
...
window.onclick = function(event) {
  ...
  <div class="container">
    <a   rel="Click Here" style="text-decoration:none;color:red;" href="judges.php"><h5>&#9679;Judges</h5></a>
...
<div class="centerbar">
  <h2>Chief Justice &amp; Judges</h2>
  <hr>
   
    <div class="leftbar">
        <img src="img/ranjangogoi.jpg">
    </div>
 <div class='centerbar'>
     <h1>Hon'ble Mr. Justice Ranjan Gogoi</h1>
      <h2>The Chief Justice Of India</h2>
      <h4>DoB : 18-11-1954</h4>
<h4>Term of Office: (DoA) 23-04-2012 to (DoR) 17-11-2019</h4>
<h4>Appointed as The Chief Justice of India on 03-10-2018</h4>
    </div>
    <br><br><br><br><br><br>
 <table >
  <tr>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> ". $row["id"]."</td><td>" . $row["name"]."</td><td>".$row["designation"]."</td><td>".$row["dob"]."</td><td>".$row["doa"]."</td><td>".$row["dor"]."</td><td>".$row["nj"]."</td><td>".$row["about"]."</td></tr>";
    }
} else {
    echo "0 results";
}
